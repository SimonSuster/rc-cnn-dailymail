...
if __name__ == "__main__":
    ...
    parser.add_argument('-log_file', help='General log name. To this we append a run descriptor.',
                        default="/home/suster/Apps/rc-cnn-dailymail/experiments/hypersearch")
    ...
    for n in range(search_args.n_times):
        ...
        #params = {"dropout_rate": 0.61, "hidden_size": 72}
        print(params)
        command = " ".join(["THEANO_FLAGS=mode=FAST_RUN,device=gpu,floatX=float32 python", "main.py"] +
            ...
            #["--train_file /home/suster/Apps/rc-cnn-dailymail/data/train1.0.json --dev_file /home/suster/Apps/rc-cnn-dailymail/data/dev1.0.json --embedding_file /nas/corpora/accumulate/clicr/embeddings/de004a58-6eef-11e7-ac2f-901b0e5592c8/embeddings"] + \
